...
export function StatusBar() {
  ...
  const showTokenStats = useTabStore(state => state.viewSettings.showTokenStats)
  const indexingScope = useTabStore(state => state.viewSettings.indexingScope)
          ...
          {tokenState.status === 'calculating' ? (
            ...
            <>
              ...
              >
                ...
                {tokenState.cached && (
                  <span className={`${styles.badge} ${styles.badgeCached}`}>Cached</span>
                )}
