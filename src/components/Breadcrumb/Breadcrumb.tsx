...
export function Breadcrumb() {
  const { tabs, activeTabId, addTab, setActiveTab, updateTab, openFolderPath } = useTabStore(
    useShallow(state => ({
      tabs: state.tabs,
  ...
  const showBreadcrumb = useTabStore(state => state.viewSettings.showBreadcrumb)
  ...
  if (!showBreadcrumb || !activeTab) return null
